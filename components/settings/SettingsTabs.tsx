...
export function SettingsTabs({ usersTab, printConfigTab, expenseCategoriesTab, smsTab, generalTab }: SettingsTabsProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Tab Navigation */}
      <div className="flex overflow-x-auto whitespace-nowrap bg-slate-100 dark:bg-[#0f1a0f] p-1.5 rounded-xl border border-emerald-900/10 gap-1 no-scrollbar sm:w-fit">
        {tabs.map(tab => (
          <button
            key={tab.id}

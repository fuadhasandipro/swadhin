      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="p-2 bg-white/20 rounded-lg">
                <Calculator className="h-5 w-5 text-indigo-50" />
              </div>
            </div>
            <p className="text-indigo-100 text-sm font-medium mb-1">Total Salary Amount</p>
            <h3 className="text-3xl font-bold font-mono">৳{summary.totalSalary.toLocaleString()}</h3>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white shadow-md border-0">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="p-2 bg-white/20 rounded-lg">
                <Wallet className="h-5 w-5 text-emerald-50" />
              </div>
            </div>
            <p className="text-emerald-100 text-sm font-medium mb-1">Total Paid</p>
            <h3 className="text-3xl font-bold font-mono">৳{summary.totalPaid.toLocaleString()}</h3>
          </CardContent>
        </Card>

        <Card className="bg-gradient-to-br from-rose-500 to-rose-600 text-white shadow-md border-0">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="p-2 bg-white/20 rounded-lg">
            ...
            <p className="text-rose-100 text-sm font-medium mb-1">Total Due</p>
            <h3 className="text-3xl font-bold font-mono">৳{summary.totalDue.toLocaleString()}</h3>
          </CardContent>
        </Card>
      </div>
